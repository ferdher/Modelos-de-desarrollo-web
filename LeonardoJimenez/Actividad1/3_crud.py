...
#se crea objeto a partir de la clase FastAPI
app=FastAPI()
...
async def usersjson():
    return[{
    "Name":"Pedro", "Lastname":"Perez", "Age":"50", "peso":"90", "altura":"1.80"},
    {"Name":"Alfredo", "Lastname":"Garcia", "Age":"30", "peso":"75", "altura":"1.75"},
    {"Name":"Alfredo", "Lastname":"Perez", "Age":"20", "peso":"56", "altura":"1.63"},
    {"Auto":"volkswagen", "modelo":"Vento", "Año":"2015", "combustible": "gasolina", "transmision": "automatica"},
    {"Auto":"volkswagen", "modelo":"Jetta", "Año":"2005", "combustible": "diesel", "transmision": "manual"},
    {"Auto":"Chevrolet", "modelo":"Aveo", "Año":"2020", "combustible": "gasolina", "transmision": "automatica"},
    {"Name":"Leonardo", "Lastname":"Sedano", "Age":"33",  "peso":"76", "altura":"1.72"},
    { "Mascota": "perro", "raza": "electrico", "color":"cafe", "edad": "3", "peso": "8"},
    {"Mascota": "gato", "raza": "egipcio", "color":"moteado", "edad": "6", "peso": "6"},
    {"Mascota": "cerdo", "raza": "porcina", "color":"negro con cafe", "edad": ".6", "peso": "120"}]
...
@app.get("/usersclass/{passengerId}")
async def usersclass(passengerId:int):
    users=filter (lambda user: user.passengerId == passengerId, users_list)  #Función de orden superior
    try:
        return list(users)[0]
    except:
